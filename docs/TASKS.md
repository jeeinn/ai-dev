...
> **当前进度**（2026-06-16）：Phase 16 ✅ · Phase 17 ✅ · **Phase 18 待开始**。详见 [assign-workflow-progress.md](assign-workflow-progress.md)。
...
| Phase 18 | P2 | **生命周期 + Web UI + routes 移除** ← 当前 | Phase 17 |
...
- [x] Agent 评论不触发循环
- [ ] PR merge 后 workspace 回收（**Phase 18.1**）
- [x] `labeled` + `ai:*` 事件 **不产生 Task**
- [ ] routes API / 触发规则 UI **已移除**（**Phase 18.4**）
