<template>
  <div class="system-config-page">
    ...
    <el-dialog v-model="showAddTemplate" title="新增 Prompt 模板" width="700px" :close-on-click-modal="false">
      <el-form :model="newTemplate" label-width="120px">
        ...
        <el-form-item label="User Template">
          ...
          <el-button type="primary" link size="small" style="margin-top: 4px" @click="showTemplateHelp = true">查看模板变量说明</el-button>
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <!-- 模板变量说明 -->
    <el-dialog v-model="showTemplateHelp" title="User Template 模板变量说明" width="700px" :close-on-click-modal="false">
